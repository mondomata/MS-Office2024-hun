...
* Nyisd meg a <b>PowerShell</b>t (nem CMD-t): ehhez **egér jobb-gombbal** kattints a Tálcán a **Start ikonra** (vagy nyomj le **egyszerre 2 billentyűt**: [Windows] <kbd>![windowsbill](https://github.com/user-attachments/assets/59c9e0ed-b6d5-4797-9d13-dc078c2245b2)</kbd> és <kbd>X</kbd>), válaszd a felugró listán a **PowerShell(vagy Terminál)** lehetőséget. (Régebbi Windows 10-en: ha nincs Powershell vagy Terminál a listán, akkor válaszd a **Parancssor**-t, majd a megnyílő ablakba írd be: <tt>powershell</tt> és nyomj <kbd>&#8629;Enter</kbd>-t.)
