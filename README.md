...
<img style="border: solid 10 px ivory;" width="200" height="130" alt="OfficeHome" src="https://github.com/user-attachments/assets/fb2e9f86-3de7-45df-a816-134889a82b05" />
...
* 🖱️ Rákattintva (duplán) a letöltött fájlra <b>megkezdődik a telepítés</b>.<sup>internet kapcs. kell, sebességtől függően a telepítés kb. 3-5 percig tart; a telepítés menetét egy külön kis ablakban mutatja a Windows</sup>
...
A **MS O365 Basic**
<a title="a Microsoft hivatalos live.com szerveréről töltődik le a telepítőfájl" href="https://c2rsetup.officeapps.live.com/c2r/download.aspx?productreleaseID=O365AppsBasicRetail&platform=x64&language=hu-hu&version=O16GA"> 👉 letöltése Microsofttól</a>
vagy közvetlenül erről a github tárhelyről <a href="O365OfficeSetup.exe">**👉 MS O365 Basic - ide kattintva**</a>❤️
...
* Másold be az <b>alábbi kódot egyetlen sorba</b> a Powershell (Terminál) ablakba, majd nyomj <kbd>&#8629;Enter</kbd>-t: 
 ...
 ~~~
*Az aktivátor program kb 1 perc alatt **automatikus**an lefut, a végén zöld sorban jelzi, hogy "Office is permanently activated", tehát az "office véglegesen aktiválva".*
Ennyi.
