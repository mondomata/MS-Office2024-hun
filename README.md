...
* Nyisd meg a <b>PowerShell</b>t (nem CMD-t): ehhez nyomd le egyszerre az **alábbi 2 billentyűt**: [Windows] <b><kbd>![windowsbill](https://github.com/user-attachments/assets/59c9e0ed-b6d5-4797-9d13-dc078c2245b2)</kbd> és <kbd>&#x58;</kbd></b> (avagy *egér jobb-gombbal* kattints a Tálcán a Startmenü ikonra), válaszd a felugró listán a PowerShell (Terminál) lehetőséget.
